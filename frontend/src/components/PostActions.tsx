...
export default function PostActions({ commentCount, commentsOpen, onToggleComments }: Props) {
  return (
    <div className="flex flex-row gap-4 py-4 md:flex-col md:items-center md:gap-6 md:py-0">
      {/* Like button — placeholder for now, no backend yet: always shows 0, click does nothing. */}
      <ActionButton count={0}>
        <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
          <path d="M12 21s-6.7-4.35-9.3-8.1C1 10.2 1.6 6.9 4.3 5.4c2.2-1.2 4.6-.5 6 1.3l1.7 2.1 1.7-2.1c1.4-1.8 3.8-2.5 6-1.3 2.7 1.5 3.3 4.8 1.6 7.5C18.7 16.65 12 21 12 21z" />
        </svg>
      </ActionButton>
